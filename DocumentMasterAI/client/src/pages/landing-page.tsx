      ...
      <header className="bg-white dark:bg-background border-b border-border py-4">
        <div className="container mx-auto px-4 flex justify-between items-center">
          <div className="flex items-center space-x-2">
            ...
            <span className="font-heading font-bold text-xl bg-gradient-to-r from-purple-600 to-pink-600 text-transparent bg-clip-text">QuantumCure AI</span>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="relative z-10">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-6 tracking-tight">
                <span className="bg-gradient-to-r from-indigo-600 to-purple-600 text-transparent bg-clip-text">Quantum-Enhanced</span> <br />
                <span className="bg-gradient-to-r from-purple-600 to-pink-600 text-transparent bg-clip-text">Life-Saving Care</span>
              </h1>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-2 gap-6">
              <img 
                src="https://images.unsplash.com/photo-1576671537586-ca4eebc86956?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80" 
                alt="Radiation dose distribution" 
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="font-heading font-bold bg-gradient-to-r from-purple-600 to-pink-600 text-transparent bg-clip-text">QuantumCure AI</span>
              </div>
          ...
          <div className="border-t border-border pt-8 text-center text-muted-foreground text-sm">
            <p className="flex items-center justify-center">
              <span>© 2025 QuantumCure AI. All rights reserved.</span>
